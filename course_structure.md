...
> [На дом](https://github.com/vvihorev/TinyBootcamp/blob/main/lessons/1p_input_output.md): ввод и вывод данных с помощью функций `print()`, и `input()`.
...
> [На дом](https://github.com/vvihorev/TinyBootcamp/blob/main/lessons/2p_datatypes_conditions.md): Задачи на использование математических операторов и условий.
...
## 5. Стуктуры данных: списки, множества, словари, кортежи, строки
